          ...
          <div data-custom-class='body'>
                ...
                <strong>
                  <span style={{ fontSize: '15px' }}>
                    <span data-custom-class='subtitle'>
                      Last updated <bdt className='question'>May 10, 2022</bdt>
                    </span>
                  </span>
                </strong>
              </span>
              ...
              <span style={{ color: 'rgb(127, 127, 127)' }}>
                <span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>
                  <span data-custom-class='body_text'>
                    ...
                    <bdt className='question'>Examidentity Hcmus </bdt>
                  ...
                  <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                    <span data-custom-class='body_text'>
                      ...
                      <bdt className='question'>
                        https://hcmus.examidentity.online/
                      </bdt>
                      <span style={{ fontSize: '15px' }}>
                        <span style={{ color: 'rgb(89, 89, 89)' }}>
                          <span data-custom-class='body_text'>
            ...
            <div>
              ...
              <div style={{ lineHeight: '1.5' }}>
                <span style={{ fontSize: '15px' }}>
                  <span data-custom-class='body_text'>
                    <strong>How do I exercise my rights?</strong> The easiest
                    way to exercise your rights is by filling out our data
                ...
                <a
                  ...
                  href='https://app.termly.io/notify/c0cb2250-b73f-43bf-a9ab-2338a8b4b4d5'
                  ...
                  <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                    ...
                    >
                      <span data-custom-class='body_text'>
                        <span style={{ fontSize: '15px' }}>
                          <span data-custom-class='body_text'>
                            <bdt className='question'>student code</bdt>
                          </span>
                        </span>
                      </span>
                    </span>
                    ...
                    >
                      <span data-custom-class='body_text'>
                        <span style={{ fontSize: '15px' }}>
                          <span data-custom-class='body_text'>
                            <bdt className='question'>
                              image for identification, analysis
                            </bdt>
                          </span>
                        </span>
                      </span>
