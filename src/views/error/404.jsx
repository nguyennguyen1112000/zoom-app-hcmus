                  ...
                  <div className="auth-form  ml-auto mr-auto no-float">
                    <div className="row">
                      <div className="col-sm-12 col-xs-12">
                        <div className="mb-30">
                          <span className="block error-head text-center txt-success mb-10">404</span>
                          <span className="text-center nonecase-font mb-20 block error-comment">Page Not Found</span>
                          <p className="text-center">The URL may be misplaced or the pahe you are looking is no longer available.</p>
                        </div>	
                      </div>	
                    </div>
                  </div>
